...
PROJECT_NAME="aws-creds"
BIN_NAME="aws-creds"
LDFLAGS_BASE="github.com/thbishop/aws-creds/aws-creds"
...
for os in ${OS_TYPES[*]}; do
    ...
    env GOOS=$os GOARCH=amd64 go build -ldflags "$ld_flags" -o $pkg_path/$BIN_NAME ./$PROJECT_NAME
    cd $PKG_ROOT
